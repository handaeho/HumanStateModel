...
def rtsp_video():
    ...
    # 웹캠 설정
    video_capture.set(3, 800)  # 영상 가로 길이 설정
    video_capture.set(4, 600)  # 영상 세로 길이 설정
    fps = 30
    ...
    # 파일 저장하기 위한 변수 선언
    path = f'/home/gaion/WTC_deepview/cctv_rtsp_vedios/{file_name}.avi'
    ...
    while True:
        ...
        # 촬영되는 영상을 보여준다. 프로그램 상태바 이름은 'streaming video' 로 뜬다.
