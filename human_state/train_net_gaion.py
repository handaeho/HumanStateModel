...
dataset_root = '/gpu-home/hsenet_dataset/'
...
register_coco_instances("IHP_train", meta, dataset_root + "IHP-E/annotations/instances_mphbE_train2021.json", dataset_root + "IHP-E/train2021", dataset_source=0)
register_coco_instances("IHP_test", meta, dataset_root + "IHP-E/annotations/instances_mphbE_test2021.json", dataset_root + "IHP-E/test2021", dataset_source=0)
...
register_coco_instances("IHPE2021_train", meta, dataset_root + "IHPE/annotations/instances_mphbE_train2021.json",
                        dataset_root + "IHPE/train2021")
register_coco_instances("IHPE2021_test", meta, dataset_root + "IHPE/annotations/instances_mphbE_test2021.json",
                        dataset_root + "IHPE/test2021")
