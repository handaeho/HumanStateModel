...
stanford40_name = ['applauding', 'blowing_bubbles', 'brushing_teeth', 'cleaning_the_floor', 'climbing', 'cooking',
                   ...
                   'shooting_an_arrow',
                   'smoking', 'taking_photos', 'texting_message', 'throwing_frisby', 'using_a_computer',
                   'walking_the_dog',
    ...
    def overlay_instances(
        ...
        for i in range(num_instances):
            ...
            if labels is not None:
                ...
                # save and pass current label and x, y coordinates
                Visualizer.now_label = labels[i]
                Visualizer.now_coord = text_pos
