...
def producer(stream_index, rtsp_info, frame_queue):
    ...
    frame_interval = 25  # 읽어온 프레임 중 큐에 넣을 주기 -> 30fps 일 경우, 30으로 설정 시, 1초에 1프레임 input
...
def consumer(frame_queue, event_queue, send_events, vis):
    ...
    while True:
        ...
        print(f"now running No.1 ... / the RTSP ID currently being processed is {rtsp_id}", end='\r')
        try:
            with torch.no_grad():
                try:
...
if __name__ == '__main__':
    ...
    rtsp_streams = [{"cameraId": "0", "cameraName": "1번 카메라", "rtsp_url": "rtsp://admin:!gaion3413@192.168.2.200:558/LiveChannel/2/media.smp"},
                    {"cameraId": "1", "cameraName": "2번 카메라", "rtsp_url": "rtsp://admin:!gaion3413@192.168.2.200:558/LiveChannel/2/media.smp"},
                    {"cameraId": "2", "cameraName": "3번 카메라", "rtsp_url": "rtsp://admin:!gaion3413@192.168.2.200:558/LiveChannel/2/media.smp"},
                    {"cameraId": "3", "cameraName": "4번 카메라", "rtsp_url": "rtsp://admin:!gaion3413@192.168.2.200:558/LiveChannel/2/media.smp"},
                    {"cameraId": "4", "cameraName": "5번 카메라", "rtsp_url": "rtsp://admin:!gaion3413@192.168.2.200:558/LiveChannel/2/media.smp"},
                    {"cameraId": "5", "cameraName": "6번 카메라", "rtsp_url": "rtsp://admin:!gaion3413@192.168.2.200:558/LiveChannel/2/media.smp"},
                    {"cameraId": "6", "cameraName": "7번 카메라", "rtsp_url": "rtsp://admin:!gaion3413@192.168.2.200:558/LiveChannel/2/media.smp"},
                    {"cameraId": "7", "cameraName": "8번 카메라", "rtsp_url": "rtsp://admin:!gaion3413@192.168.2.200:558/LiveChannel/2/media.smp"},
                    {"cameraId": "8", "cameraName": "9번 카메라", "rtsp_url": "rtsp://admin:!gaion3413@192.168.2.200:558/LiveChannel/2/media.smp"},
                    {"cameraId": "9", "cameraName": "10번 카메라", "rtsp_url": "rtsp://admin:!gaion3413@192.168.2.200:558/LiveChannel/2/media.smp"}]
